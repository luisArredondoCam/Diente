...
<main>
        <div class="fondo">
            <br>
            <h1 style="font-size: 50px; padding: 0 17%;">{{mostrar_info('titulo_Protesis_Parcial')}}</h1>
        ...
        <div class="container text-center" style="margin-top: 25px;">
            <div class="row">
                <div class="col-md-6">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        {{mostrar_info('descripcion_Protesis_Parcial')}}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <h3 style="color: rgb(15, 124, 167);">Duracion</h3>
                                <p style="text-align: justify; margin-top: 12px;font-size: 18px;">
                                {{mostrar_info('descripcion_Duracion_Protesis_Parcial')}}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <img src="images/Imagen-Protesis-Parcial.png" class="img-fluid" alt="..." style="width: 100%; height: 100%;">
                </div>
            </div>
        </div>
    </main>
