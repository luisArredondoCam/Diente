...
<main>
        <div class="fondo">
            <br>
            <h1 style="font-size: 50px; padding: 0 17%;">{{mostrar_info('titulo_Protesis_total')}}</h1>
        ...
        <div class="container text-center" style="margin-top: 25px;">
            <div class="row">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        {{mostrar_info('descripcion_Protesis_total')}}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                {{mostrar_info('descripcion_recomendaciones_Protesis_total')}}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <img src="Images/Imagen-Protesis-Total.png" class="img-fluid" alt="..." style="width: 100%; height: 100%;">
                </div>
            </div>
        </div>
    </main>
