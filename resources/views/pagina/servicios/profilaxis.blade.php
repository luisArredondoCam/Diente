...
<main>
        <div class="fondo">
            <br>
            <h1 style="font-size: 50px; padding:0 17%;">{{mostrar_info('titulo_Profilaxis')}}</h1>
        ...
        <div class="container text-center" style="margin-top: 25px;">
            <div class="row">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {{mostrar_info('descripcion_Profilaxis')}}
                                </p>
                            </div>
                            <div class="col-md-12" style="margin-top: 15px;font-size: 20px;">
                                <h3 style="margin-top: 30px;">¿Cuando no hacer una profilaxis?</h3>
                                <p style="text-align: justify; margin-top: 12px;">
                                {{mostrar_info('descripcion_pregunta_Profilaxis')}}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <img src="{{mostrar_info('imagen_Profilaxis')}}" class="img-fluid" alt="..." style="width: 100%; height: 100%;">
                </div>
            </div>
        </div>
    </main>
